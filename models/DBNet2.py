...
class DBNet2(nn.Module):
    ...
    def __init__(self, kernels, Samples, hidden_chans:int=32, temporalLayer = 'LogVarLayer', strideFactor= 4,
        ...
        self.convblock = nn.Sequential(
            ...
            nn.Conv1d(in_channels=self.planes, out_channels=self.planes, kernel_size=1,
        ...
        self.bn = nn.BatchNorm1d(num_features=2*2*self.planes)
