...
from tlutils.loss import MultipleKernelMaximumMeanDiscrepancy, GaussianKernel
...
def train(trainloader,valloader, testloader, savepath,args):
    ...
    mkmmd_loss_func = MultipleKernelMaximumMeanDiscrepancy(
    ...
    for epoch in tqdm(range(args.epoch),desc="Training:"):
        ...
        while iter_num < max_iter:
            ...
            align_loss = mkmmd_loss_func(fea_src, fea_tar)
